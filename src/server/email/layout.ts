  ...
  <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#f6f5f1;padding:32px 16px;">
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:520px;">
        ...
        <tr><td style="background:#ffffff;border-radius:14px;padding:32px 32px 28px;font-family:'Instrument Sans','Segoe UI',system-ui,-apple-system,sans-serif;color:#1a1815;">
          <h1 style="margin:0 0 14px;font-size:20px;line-height:1.3;font-weight:600;letter-spacing:-0.01em;">${heading}</h1>
          <div style="font-size:15px;line-height:1.6;color:#3d3a35;">${bodyHtml}</div>
          ${
            cta
              ? `<table role="presentation" cellpadding="0" cellspacing="0" style="margin-top:24px;"><tr><td style="border-radius:10px;background:#e85d2b;">
                   <a href="${cta.url}" style="display:inline-block;padding:11px 22px;font-family:'Instrument Sans','Segoe UI',system-ui,sans-serif;font-size:15px;font-weight:600;color:#fff7f2;text-decoration:none;border-radius:10px;">${escapeHtml(cta.label)}</a>
                 </td></tr></table>`
              : ""
          }
        </td></tr>
        <tr><td style="padding:18px 8px 0;font-family:'Instrument Sans','Segoe UI',system-ui,sans-serif;font-size:12px;line-height:1.5;color:#9a948b;">
